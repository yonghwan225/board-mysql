...
//        return dtos;
    ...
    public CommentDto update(Long id, CommentDto dto) {
        ...
        Comment dbData = commentRepository.findById(id).orElseThrow(() -> new IllegalArgumentException("댓글 수정에 실패하였습니다." +
    ...
    public CommentDto delete(Long id) {
        // 댓글 조회
        Comment dbData = commentRepository.findById(id).orElseThrow(() -> new IllegalArgumentException("댓글없어서 삭제불가"));
        // 댓글 삭제
